#!/usr/bin/env bash
set -euo pipefail
for f in docs/release/release_process.md docs/release/versioning.md docs/release/compat_matrix.md docs/release/downgrade.md docs/runbooks/release_signing_failed.md RELEASE_CHECKLIST.md CHANGELOG.md docs/ops/go_no_go_template.md docs/en/ops/go_no_go_template.md docs/governance/release_decisions/latest_go_no_go.md docs/source/ingress_perimeter_protection_v0_2.md docs/source/trust_boundary_hardening_v0_2.md docs/source/browser_surface_hardening_v0_2.md docs/source/regart_adversarial_integration_harness_v0_2.md; do
  test -s "$f"
done
