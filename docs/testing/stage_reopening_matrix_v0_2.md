...
| `18` | `OPEN` | Agent transport/receiver contour не материализован; кроме этого отсутствует наглядная connected-system проекция declared-vs-observed coverage | `agent/src/main.rs`, receiver gaps, no outbound/relay/TLS, `docs/agent/receiver_source_coverage.md`, `docs/source/connected_system_visibility_v0_2.md` | оставить открытым |
