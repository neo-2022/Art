...
Пока статус этой программы остаётся `IN_PROGRESS`, действует жёсткое правило:
...
- До смены статуса на `COMPLETE` reopened checklist/stage items считаются рабочими и не подлежат повторному закрытию.
