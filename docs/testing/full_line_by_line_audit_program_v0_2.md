...
5. дефектовочная лестница, которая задаёт порядок corrective execution;
6. дефектовочная контрольная ведомость, которая превращает каждый найденный дефект в поштучную строку исполнения с зависимостями, stage-ссылками, тестами, evidence и контрольным чекбоксом.
...
- нельзя начинать remediation без `docs/testing/defect_remediation_control_matrix_v0_2.md` и `formats/defect_remediation_control_matrix_v0_2.yaml`.
