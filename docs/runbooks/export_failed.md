...
## symptoms
- В snapshot/stream/логах наблюдается сигнал `export_failed` или эквивалентный сбой.
...
## mitigations
- проверить параметры окна экспорта
- проверить права каталога out_dir
- повторить экспорт
