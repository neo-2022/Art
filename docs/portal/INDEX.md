...
- Threat Model Appendix внутри исторического канона: [PROJECT_HISTORY_AND_CONCEPTS.md](../foundation/PROJECT_HISTORY_AND_CONCEPTS.md)
...
- Каталог предохранителей: [protective_safeguards_catalog_v0_2.md](../source/protective_safeguards_catalog_v0_2.md)
...
- Storage pressure protection baseline: [storage_pressure_protection_v0_2.md](../source/storage_pressure_protection_v0_2.md)
...
- Queue integrity protection baseline: [queue_integrity_protection_v0_2.md](../source/queue_integrity_protection_v0_2.md)
