...
- Строк в корневом `README.md`: `183`
- Уникальных документов в дереве: `75`
- Каталоговых узлов в дереве: `3`
- Общих строк по документным узлам: `10776`
- Суммарных строк внутри каталоговых узлов: `2243`
- Всех связей в дереве: `158`
- Просканированных markdown-ссылок: `183`
- Прямых дочерних ссылок у корня: `47`
- Документов с признаком `ROOT-INFLUENCE`: `22`
...
graph TD
    ...
    N68["docs/source/ingress_perimeter_protection_v0_2.md\n149 строк"]
    N69["docs/source/regart_adversarial_integration_harness_v0_2.md\n172 строк\nROOT-INFLUENCE"]
    N70["docs/source/risk_register_v0_2.md\n45 строк\nROOT-INFLUENCE"]
    N71["docs/source/secure_actions_protocol_v2.md\n27 строк"]
    N72["docs/source/trust_boundary_hardening_v0_2.md\n132 строк\nROOT-INFLUENCE"]
    N73["docs/testing/buyer_due_diligence_signal_triage_v0_2.md\n66 строк"]
    N74["docs/testing/defect_remediation_control_matrix_v0_2.md\n624 строк\nROOT-INFLUENCE"]
    N75["docs/testing/defect_remediation_ladder_v0_2.md\n289 строк\nROOT-INFLUENCE"]
    N76["docs/testing/production_adversarial_validation_law.md\n203 строк"]
    N77["docs/testing/test_system_audit_v0_2.md\n97 строк"]
    N78["formats/platform_support.yaml\n253 строк"]
    N2 --> N26
    N2 --> N3
    N2 --> N1
    N2 --> N35
...
- [`README.md`](../../README.md) — `183` строк
  ...
  - [`docs/testing/defect_remediation_control_matrix_v0_2.md`](../testing/defect_remediation_control_matrix_v0_2.md) — `624` строк `ROOT-INFLUENCE`
  - [`docs/testing/defect_remediation_ladder_v0_2.md`](../testing/defect_remediation_ladder_v0_2.md) — `289` строк `ROOT-INFLUENCE`
  - [`docs/source/ingress_perimeter_protection_v0_2.md`](../source/ingress_perimeter_protection_v0_2.md) — `149` строк
  - [`docs/source/trust_boundary_hardening_v0_2.md`](../source/trust_boundary_hardening_v0_2.md) — `132` строк `ROOT-INFLUENCE`
  - [`docs/source/browser_surface_hardening_v0_2.md`](../source/browser_surface_hardening_v0_2.md) — `105` строк `ROOT-INFLUENCE`
  - [`docs/source/regart_adversarial_integration_harness_v0_2.md`](../source/regart_adversarial_integration_harness_v0_2.md) — `172` строк `ROOT-INFLUENCE`
  - [`docs/source/connected_system_visibility_v0_2.md`](../source/connected_system_visibility_v0_2.md) — `191` строк `ROOT-INFLUENCE`
  ...
  - [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `791` строк `ROOT-INFLUENCE`
  - [`docs/source/checklists/CHECKLIST_00_MASTER_ART_REGART.md`](../source/checklists/CHECKLIST_00_MASTER_ART_REGART.md) — `312` строк `ROOT-INFLUENCE`
  - [`docs/source/checklists/CHECKLIST_38_STAGE_LADDER_ENFORCEMENT.md`](../source/checklists/CHECKLIST_38_STAGE_LADDER_ENFORCEMENT.md) — `82` строк `ROOT-INFLUENCE`
  ...
  - [`docs/README.md`](../README.md) — `107` строк `ROOT-INFLUENCE`
    - [`docs/source/Art_v1_spec_final.md`](../source/Art_v1_spec_final.md) — `614` строк `ROOT-INFLUENCE`
    - [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `791` строк `ROOT-INFLUENCE`
    - [`docs/source/checklists/CHECKLIST_00_MASTER_ART_REGART.md`](../source/checklists/CHECKLIST_00_MASTER_ART_REGART.md) — `312` строк `ROOT-INFLUENCE`
    - [`docs/source/README.md`](../source/README.md) — `83` строк `ROOT-INFLUENCE`
    - [`README.md`](../../README.md) — `183` строк `REUSED-LINK`
    - [`docs/portal/INDEX.md`](INDEX.md) — `68` строк
      - [`docs/README.md`](../README.md) — `107` строк `ROOT-INFLUENCE` `REUSED-LINK`
      - [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `791` строк `ROOT-INFLUENCE`
      - [`docs/source/checklists/CHECKLIST_00_MASTER_ART_REGART.md`](../source/checklists/CHECKLIST_00_MASTER_ART_REGART.md) — `312` строк `ROOT-INFLUENCE`
      - [`docs/INTEGRATION.md`](../INTEGRATION.md) — `60` строк `ROOT-INFLUENCE`
      ...
      - [`docs/foundation/PROJECT_HISTORY_AND_CONCEPTS.md`](../foundation/PROJECT_HISTORY_AND_CONCEPTS.md) — `931` строк `ROOT-INFLUENCE`
      ...
      - [`docs/source/REGART -  LangGraph  взаимодействие с Art описание.md`](../source/REGART -  LangGraph  взаимодействие с Art описание.md) — `313` строк `ROOT-INFLUENCE`
      - [`docs/testing/defect_remediation_ladder_v0_2.md`](../testing/defect_remediation_ladder_v0_2.md) — `289` строк `ROOT-INFLUENCE`
      - [`docs/ARCHITECTURE.md`](../ARCHITECTURE.md) — `96` строк
        - [`docs/source/Art_v1_spec_final.md`](../source/Art_v1_spec_final.md) — `614` строк `ROOT-INFLUENCE`
        - [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `791` строк `ROOT-INFLUENCE`
      ...
      - [`docs/portal/DELIVERY_EVIDENCE.md`](DELIVERY_EVIDENCE.md) — `26` строк
      - [`docs/testing/buyer_due_diligence_signal_triage_v0_2.md`](../testing/buyer_due_diligence_signal_triage_v0_2.md) — `66` строк
      - [`docs/portal/SECURITY_POSTURE.md`](SECURITY_POSTURE.md) — `67` строк
      - [`docs/source/ingress_perimeter_protection_v0_2.md`](../source/ingress_perimeter_protection_v0_2.md) — `149` строк
      - [`docs/source/trust_boundary_hardening_v0_2.md`](../source/trust_boundary_hardening_v0_2.md) — `132` строк `ROOT-INFLUENCE`
      - [`docs/source/browser_surface_hardening_v0_2.md`](../source/browser_surface_hardening_v0_2.md) — `105` строк `ROOT-INFLUENCE`
      - [`docs/source/regart_adversarial_integration_harness_v0_2.md`](../source/regart_adversarial_integration_harness_v0_2.md) — `172` строк `ROOT-INFLUENCE`
    ...
    - [`docs/governance/observability_gap_registry.md`](../governance/observability_gap_registry.md) — `74` строк
  ...
  - [`docs/portal/INDEX.md`](INDEX.md) — `68` строк
    - [`docs/README.md`](../README.md) — `107` строк `ROOT-INFLUENCE`
      ...
      - [`docs/source/README.md`](../source/README.md) — `83` строк `ROOT-INFLUENCE`
      - [`README.md`](../../README.md) — `183` строк `REUSED-LINK`
      - [`docs/portal/INDEX.md`](INDEX.md) — `68` строк `REUSED-LINK`
      - [`docs/foundation/AI_ENGINEERING_OPERATING_MODEL.md`](../foundation/AI_ENGINEERING_OPERATING_MODEL.md) — `174` строк
      - [`docs/foundation/ADVANCED_AUTOMATION_BACKLOG.md`](../foundation/ADVANCED_AUTOMATION_BACKLOG.md) — `183` строк
      - [`docs/foundation/PROJECT_HISTORY_AND_CONCEPTS.md`](../foundation/PROJECT_HISTORY_AND_CONCEPTS.md) — `931` строк `ROOT-INFLUENCE`
      - [`docs/foundation/UNIVERSAL_PROJECT_IDEOLOGY_TEMPLATE.md`](../foundation/UNIVERSAL_PROJECT_IDEOLOGY_TEMPLATE.md) — `537` строк
...
- [`docs/INTEGRATION.md`](../INTEGRATION.md) — `60` строк
- [`docs/README.md`](../README.md) — `107` строк
- [`docs/foundation/PROJECT_HISTORY_AND_CONCEPTS.md`](../foundation/PROJECT_HISTORY_AND_CONCEPTS.md) — `931` строк
...
- [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `791` строк
- [`docs/source/README.md`](../source/README.md) — `83` строк
...
- [`docs/source/browser_surface_hardening_v0_2.md`](../source/browser_surface_hardening_v0_2.md) — `105` строк
- [`docs/source/checklists/CHECKLIST_00_MASTER_ART_REGART.md`](../source/checklists/CHECKLIST_00_MASTER_ART_REGART.md) — `312` строк
- [`docs/source/checklists/CHECKLIST_38_STAGE_LADDER_ENFORCEMENT.md`](../source/checklists/CHECKLIST_38_STAGE_LADDER_ENFORCEMENT.md) — `82` строк
- `docs/source/checklists/TRACEABILITY_V0_2.md` — `НЕ ПОПАЛ В ДЕРЕВО`
- [`docs/source/connected_system_visibility_v0_2.md`](../source/connected_system_visibility_v0_2.md) — `191` строк
- [`docs/source/dna_core_determinism_performance_assurance.md`](../source/dna_core_determinism_performance_assurance.md) — `138` строк
- [`docs/source/regart_adversarial_integration_harness_v0_2.md`](../source/regart_adversarial_integration_harness_v0_2.md) — `172` строк
- [`docs/source/risk_register_v0_2.md`](../source/risk_register_v0_2.md) — `45` строк
- [`docs/source/trust_boundary_hardening_v0_2.md`](../source/trust_boundary_hardening_v0_2.md) — `132` строк
- [`docs/testing/defect_remediation_control_matrix_v0_2.md`](../testing/defect_remediation_control_matrix_v0_2.md) — `624` строк
- [`docs/testing/defect_remediation_ladder_v0_2.md`](../testing/defect_remediation_ladder_v0_2.md) — `289` строк
