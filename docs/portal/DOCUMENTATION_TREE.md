...
- Общих строк по документным узлам: `10773`
...
- [`README.md`](../../README.md) — `183` строк
  ...
  - [`docs/testing/defect_remediation_control_matrix_v0_2.md`](../testing/defect_remediation_control_matrix_v0_2.md) — `621` строк `ROOT-INFLUENCE`
...
- [`docs/testing/defect_remediation_control_matrix_v0_2.md`](../testing/defect_remediation_control_matrix_v0_2.md) — `621` строк
