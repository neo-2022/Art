...
- Строк в корневом `README.md`: `181`
- Уникальных документов в дереве: `74`
- Каталоговых узлов в дереве: `3`
- Общих строк по документным узлам: `10461`
- Суммарных строк внутри каталоговых узлов: `2243`
- Всех связей в дереве: `155`
- Просканированных markdown-ссылок: `178`
- Прямых дочерних ссылок у корня: `46`
- Документов с признаком `ROOT-INFLUENCE`: `20`
...
graph TD
    ...
    N68["docs/source/regart_adversarial_integration_harness_v0_2.md\n172 строк\nROOT-INFLUENCE"]
    N69["docs/source/risk_register_v0_2.md\n45 строк\nROOT-INFLUENCE"]
    N70["docs/source/secure_actions_protocol_v2.md\n27 строк"]
    N71["docs/source/trust_boundary_hardening_v0_2.md\n132 строк\nROOT-INFLUENCE"]
    N72["docs/testing/buyer_due_diligence_signal_triage_v0_2.md\n66 строк"]
    N73["docs/testing/defect_remediation_control_matrix_v0_2.md\n594 строк\nROOT-INFLUENCE"]
    N74["docs/testing/defect_remediation_ladder_v0_2.md\n287 строк\nROOT-INFLUENCE"]
    N75["docs/testing/production_adversarial_validation_law.md\n203 строк"]
    N76["docs/testing/test_system_audit_v0_2.md\n97 строк"]
    N77["formats/platform_support.yaml\n253 строк"]
    N2 --> N26
    N2 --> N3
    N2 --> N1
    N2 --> N35
...
- [`README.md`](../../README.md) — `181` строк
  ...
  - [`docs/testing/defect_remediation_control_matrix_v0_2.md`](../testing/defect_remediation_control_matrix_v0_2.md) — `594` строк `ROOT-INFLUENCE`
  - [`docs/testing/defect_remediation_ladder_v0_2.md`](../testing/defect_remediation_ladder_v0_2.md) — `287` строк `ROOT-INFLUENCE`
  ...
  - [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `756` строк `ROOT-INFLUENCE`
  ...
  - [`docs/README.md`](../README.md) — `105` строк `ROOT-INFLUENCE`
    - [`docs/source/Art_v1_spec_final.md`](../source/Art_v1_spec_final.md) — `614` строк `ROOT-INFLUENCE`
    - [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `756` строк `ROOT-INFLUENCE`
    - [`docs/source/checklists/CHECKLIST_00_MASTER_ART_REGART.md`](../source/checklists/CHECKLIST_00_MASTER_ART_REGART.md) — `312` строк `ROOT-INFLUENCE`
    - [`docs/source/README.md`](../source/README.md) — `80` строк `ROOT-INFLUENCE`
    - [`README.md`](../../README.md) — `181` строк `REUSED-LINK`
    - [`docs/portal/INDEX.md`](INDEX.md) — `67` строк
      - [`docs/README.md`](../README.md) — `105` строк `ROOT-INFLUENCE` `REUSED-LINK`
      - [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `756` строк `ROOT-INFLUENCE`
      - [`docs/source/checklists/CHECKLIST_00_MASTER_ART_REGART.md`](../source/checklists/CHECKLIST_00_MASTER_ART_REGART.md) — `312` строк `ROOT-INFLUENCE`
      - [`docs/INTEGRATION.md`](../INTEGRATION.md) — `60` строк `ROOT-INFLUENCE`
        ...
        - [`docs/source/checklists/CHECKLIST_20_PACK_REGART.md`](../source/checklists/CHECKLIST_20_PACK_REGART.md) — `134` строк
        - [`docs/source/regart_adversarial_integration_harness_v0_2.md`](../source/regart_adversarial_integration_harness_v0_2.md) — `172` строк `ROOT-INFLUENCE`
        - [`docs/testing/defect_remediation_ladder_v0_2.md`](../testing/defect_remediation_ladder_v0_2.md) — `287` строк `ROOT-INFLUENCE`
      ...
      - [`docs/foundation/PROJECT_HISTORY_AND_CONCEPTS.md`](../foundation/PROJECT_HISTORY_AND_CONCEPTS.md) — `908` строк `ROOT-INFLUENCE`
  ...
  - [`docs/portal/INDEX.md`](INDEX.md) — `67` строк
    - [`docs/README.md`](../README.md) — `105` строк `ROOT-INFLUENCE`
      ...
      - [`docs/source/README.md`](../source/README.md) — `80` строк `ROOT-INFLUENCE`
      - [`README.md`](../../README.md) — `181` строк `REUSED-LINK`
      - [`docs/portal/INDEX.md`](INDEX.md) — `67` строк `REUSED-LINK`
      - [`docs/foundation/AI_ENGINEERING_OPERATING_MODEL.md`](../foundation/AI_ENGINEERING_OPERATING_MODEL.md) — `174` строк
      - [`docs/foundation/ADVANCED_AUTOMATION_BACKLOG.md`](../foundation/ADVANCED_AUTOMATION_BACKLOG.md) — `183` строк
      - [`docs/foundation/PROJECT_HISTORY_AND_CONCEPTS.md`](../foundation/PROJECT_HISTORY_AND_CONCEPTS.md) — `908` строк `ROOT-INFLUENCE`
      - [`docs/foundation/UNIVERSAL_PROJECT_IDEOLOGY_TEMPLATE.md`](../foundation/UNIVERSAL_PROJECT_IDEOLOGY_TEMPLATE.md) — `537` строк
...
- [`docs/README.md`](../README.md) — `105` строк
- [`docs/foundation/PROJECT_HISTORY_AND_CONCEPTS.md`](../foundation/PROJECT_HISTORY_AND_CONCEPTS.md) — `908` строк
...
- [`docs/source/FOUNDATION_CONSTITUTION_V0_2.md`](../source/FOUNDATION_CONSTITUTION_V0_2.md) — `756` строк
- [`docs/source/README.md`](../source/README.md) — `80` строк
...
- [`docs/testing/defect_remediation_control_matrix_v0_2.md`](../testing/defect_remediation_control_matrix_v0_2.md) — `594` строк
- [`docs/testing/defect_remediation_ladder_v0_2.md`](../testing/defect_remediation_ladder_v0_2.md) — `287` строк
