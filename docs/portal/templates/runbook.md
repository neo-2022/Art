...
## Что это такое
Коротко объяснить, что это за инцидент, защитный сигнал или operational-сценарий.

## Зачем этот runbook нужен
Объяснить простыми словами, какой риск он помогает локализовать и почему важно действовать по шагам.

## Термины и сокращения
- Расшифровать специальные слова, сигналы, названия режимов и статусов.
...
Коротко объяснить человеческим языком:
- что именно произошло;
- почему это опасно;
- как понять, что ситуация действительно локализована.
