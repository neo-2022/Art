...
| R9 | Privacy/compliance риски evidence | Низкая->Высокая в прод | Критическое | privacy-by-design, redaction enforcement, evidence access audit, forget/anonymize workflow | 30,36,37 | stage30-evidence-claims-tests, stage36-saas-architecture-gate, stage37-linux-hardening-gate | observability_gap.evidence_privacy_violation | unauthorized evidence access > 0 |
