...
15. [x] **Сделать:** Зафиксировать доказательство branch protection для main в репозитории.
  - [x] причина → фикс → критерий готовности: текущий PNG-пруф является 1x1 placeholder, а evidence недостаточно; заменить реальным доказательством и проверить артефакты.  
