...
- Дефектовочная ведомость располагается в стволе до `MASTER` и задаёт corrective-порядок `MASTER`, потому что именно она переводит audit findings в обязательную remediation-лестницу.
