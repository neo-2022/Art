...
Документ обязан оставаться понятным не только специалисту по безопасности, но и разработчику, оператору и аудитору. Поэтому каждый security-critical термин в этом контуре должен сопровождаться простым объяснением, а не оставаться внутренним жаргоном.
