...
## Contracts
- OpenAPI (Stage 08): `docs/api/openapi.yaml`
- JSON Schema registry (Stage 08): `docs/schemas/`
- Примечание: файлы контрактов добавляются на Stage 08; Stage 07 проверяет только наличие этой декларации.

## Безопасность
Правила репорта уязвимостей: `SECURITY.md`.

## Лицензия
Лицензия будет добавлена отдельным изменением после утверждения владельцем репозитория.
